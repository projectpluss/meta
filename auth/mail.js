...
let listemail = [
  'mailktatrade@gmail.com', 'mailktatrade@gmail.com'
];

// Vì để demo nên mình để các biến const ở đây.
const adminEmail = 'mailktatrade@gmail.com'
const adminPassword = 'zdvfjoqbdwnzicpr'
...
const sendMail = (to, subject, htmlContent) => {
  ...
  const options = {
    from: `KTATRADE <${listemail[rd]}>`, // địa chỉ admin email bạn dùng để gửi
